                    ...
                    %>
                        ...
                        <tr>
                           <td><%=  rs.getInt("CateID")%></td>
                            ...
                            <td>
                              <a style="color:white" onclick="return confirm('Are you sure? Category will restore');" class="btn bg-primary btn-sm " href="/AdminCateController/Restore/<%= rs.getInt("CateID")%>" >Restore</a> <br>  
